        ...
        sidebar: {
            '/docs/keep/': [
                ...
                },
                {
                    ...
                    collapsed: true,
                    items: [
                        {text: 'Git', link: '/docs/keep/other/Git'},
                        {text: 'Nginx', link: '/docs/keep/other/Nginx'},
                        {text: 'Maven', link: '/docs/keep/other/Maven'},
                        {text: 'Docker', link: '/docs/keep/other/Docker'},
                        {text: 'Arthas', link: '/docs/keep/other/Arthas'},
                        {text: 'FFmpeg', link: '/docs/keep/other/FFmpeg'},
                        {text: 'YT-DLP', link: '/docs/keep/other/YT-DLP'},
                        {text: 'Homebrew', link: '/docs/keep/other/Homebrew'},
                        {text: 'NVM/Volta', link: '/docs/keep/other/NVM-Volta'},
                        {text: 'WordPress', link: '/docs/keep/other/WordPress'},
                    ]
                },
            ],
            '/docs/timeline/': [
